...
st.set_page_config(page_title="Dhammi Enterprise", layout="wide")
...
if __name__ == "__main__":
    ...
    for property in properties:
        ...
        with col2:
            property_content = f"""
            <div style="border-radius:12px;box-shadow:4px;">
                ...
                <div class=container>
                    <div class=box style='min-width:20%'>
                       <div class=h_1 >🏷 Price<br> </div>
                        <div class=h_1_value>{format_currency(property['price_per_gaz'], 'INR', locale='en_IN')}/Gaz </div>
                    </div>
                    <div class=box>
                        <div class=h_1> ⎕ Area<br> </div>
                        <div class=h_1_value>{format_decimal(property['area_size_in_gaz'], locale='en_IN')} Gaz </div>
                    </div>
                    <div class=box>
                        <div class=h_1>🟰 Total Costing<br></div>
                        <div class=h_1_value>{format_currency(property['price_per_gaz'] * property['area_size_in_gaz'], 'INR', locale='en_IN')}</div>
                    </div>
                </div>
    ...
    st.markdown(
        ...
        <div style='text-align:center; color:gray; padding:20px;'>
            © 2026 Dhammi Enterprise | Real Estate Listings
        </div>
        """, unsafe_allow_html=True)
